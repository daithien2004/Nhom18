...
// Schema cho userId parameter
export const userIdSchema = z.object({
  userId: z.string().min(1, { message: "User ID là bắt buộc" }),
});

// Schema cho statistic type parameter
export const statisticTypeSchema = z.object({
  type: z.enum(["likes", "comments", "friends", "posts"], {
    message: "Loại thống kê phải là likes, comments, friends hoặc posts",
  }),
});
